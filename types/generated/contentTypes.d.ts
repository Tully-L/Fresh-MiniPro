...
export interface ApiAddressAddress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    detailAddress: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::address.address'
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    parentId: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    order_items: Schema.Attribute.Relation<
      ...
      'api::order-item.order-item'
    >;
    orderNote: Schema.Attribute.Text;
    orderStatus: Schema.Attribute.Enumeration<
      ['pending', 'completed', 'canceled']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'pending'>;
    orderTime: Schema.Attribute.DateTime & Schema.Attribute.Required;
    printStatus: Schema.Attribute.Enumeration<['notPrinted', 'printed']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'notPrinted'>;
    printTime: Schema.Attribute.DateTime & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiVariantVariant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variantDescription: Schema.Attribute.Text;
